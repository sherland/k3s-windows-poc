# =============================================================================
# Run-ScenarioA.ps1
# Test Case A: 1 control-plane + 2 Linux workers + 1 Windows node (WS2025)
...
Write-Banner "SCENARIO A — flannel + CP + $workerLabel + 1 Windows node (WS2025)"
...
Write-Host "[OK] config/variables.ps1 → CNI=flannel, LinuxWorkerCount=$workerCount, WindowsNodeSpecs=1×WS2025" -ForegroundColor Green
